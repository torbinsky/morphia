package com.github.jmkgreen.morphia.logging;

import com.github.jmkgreen.morphia.logging.jdk.JDKLoggerFactory;
...
public class MorphiaLoggerFactory {
    ...
    private static List<String> factories = new ArrayList(Arrays.asList(JDKLoggerFactory.class.getName(),
            "com.github.jmkgreen.morphia.logging.slf4j.SLF4JLogrImplFactory"));
