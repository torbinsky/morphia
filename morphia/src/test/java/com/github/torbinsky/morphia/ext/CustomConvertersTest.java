...
package com.github.torbinsky.morphia.ext;
...
import com.github.torbinsky.morphia.converters.IntegerConverter;
import com.github.torbinsky.morphia.converters.SimpleValueConverter;
...
public class CustomConvertersTest extends TestBase {
	 ...
	 * "com.github.torbinsky.morphia.mapping.MappingException: No usable constructor for A"
	 * .
	 * </p>
	 */
	...
	public void testDBObjectSerialization() {
		...
		assertEquals(BasicDBObjectBuilder.start("_id", 1l).add("a", 2l).get(),
				dbObject);
		// fails with a
		// com.github.torbinsky.morphia.mapping.MappingException: No usable
		// constructor
